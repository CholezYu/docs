...
export default function Home() {
  ...
  const addCount = () => {
    dispatch(increment(1)) // actionCreator => { type: "increment", payload: 1 }
  }

  const subCount = () => {
    dispatch(decrement(1)) // actionCreator => { type: "decrement", payload: 1 }
  }
