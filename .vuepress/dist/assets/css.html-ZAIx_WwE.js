import{_ as p,r as i,o as l,c,a as n,b as a,d as e,e as t}from"./app-F8sPig3c.js";const o={},d=t(`<h2 id="选择器" tabindex="-1"><a class="header-anchor" href="#选择器" aria-hidden="true">#</a> 选择器</h2><h3 id="伪类选择器" tabindex="-1"><a class="header-anchor" href="#伪类选择器" aria-hidden="true">#</a> 伪类选择器</h3><p>link &gt; visited &gt; hover &gt; active</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token comment">/* 未访问过的链接 */</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="重绘重排" tabindex="-1"><a class="header-anchor" href="#重绘重排" aria-hidden="true">#</a> 重绘重排</h2><div class="hint-container important"><p class="hint-container-title">重要</p><p>重绘不一定导致重排，但是重排一定会导致重绘！</p></div><h3 id="重绘" tabindex="-1"><a class="header-anchor" href="#重绘" aria-hidden="true">#</a> 重绘</h3><p>元素的样式改变，但不影响它在文档流中的位置（例如：文本颜色、背景颜色、可见性等）。</p><p>浏览器会对这些元素进行重新绘制。</p><h3 id="重排-回流" tabindex="-1"><a class="header-anchor" href="#重排-回流" aria-hidden="true">#</a> 重排（回流）</h3><ul><li><p>页面首次渲染；</p></li><li><p>浏览器窗口大小发生改变；</p></li><li><p>元素尺寸或位置发生改变；</p></li><li><p>元素内容发生变化（文字数量或图片大小等）；</p></li><li><p>元素字体大小变化；</p></li><li><p>DOM 元素的添加与删除；</p></li><li><p>一些导致重排的属性和方法：</p><ul><li><p><code>clientWidth</code> <code>clientHeight</code> <code>clientTop</code> <code>clientLeft</code></p></li><li><p><code>offsetWidth</code> <code>offsetHeight</code> <code>foosetTop</code> <code>offsetLeft</code></p></li><li><p><code>scrollWidth</code> <code>scrollHeight</code> <code>scrollTop</code> <code>scrollLest</code></p></li><li><p><code>scrollIntoView()</code> <code>scrollIntoViewIfNeeded()</code></p></li><li><p><code>getComputedStyle()</code></p></li><li><p><code>getBoundingClientRect()</code></p></li><li><p><code>scrollTo()</code></p></li></ul></li></ul><h2 id="响应式布局" tabindex="-1"><a class="header-anchor" href="#响应式布局" aria-hidden="true">#</a> 响应式布局</h2><h3 id="媒体查询" tabindex="-1"><a class="header-anchor" href="#媒体查询" aria-hidden="true">#</a> 媒体查询</h3><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token comment">/* 在屏幕上, 并且最小宽度为 900px 时（屏幕宽度大于 900px）的样式 */</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function k(m,b){const s=i("ExternalLinkIcon");return l(),c("div",null,[d,n("p",null,[n("a",u,[a("Containers · Bootstrap v5 中文文档 v5.3 | Bootstrap 中文网 (bootcss.com)"),e(s)])]),n("p",null,[n("a",r,[a("Grid system · Bootstrap v5 中文文档 v5.3 | Bootstrap 中文网 (bootcss.com)"),e(s)])]),v])}const g=p(o,[["render",k],["__file","css.html.vue"]]);export{g as default};
