import{_ as o}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as p,c,b as n,d as e,e as t,a as s}from"./app-KUyYtUlt.js";const l={},u=s(`<h2 id="基本目录" tabindex="-1"><a class="header-anchor" href="#基本目录" aria-hidden="true">#</a> 基本目录</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├── app.js
├── app.json
├── pages
│   └── index
│       ├── index.js
