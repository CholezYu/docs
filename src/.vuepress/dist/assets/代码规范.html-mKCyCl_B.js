import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,a as e}from"./app-8K1XkiCW.js";const t={},p=e(`<h2 id="prettier" tabindex="-1"><a class="header-anchor" href="#prettier" aria-hidden="true">#</a> prettier</h2><p>安装 prittier 及相关插件。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> prettier eslint-config-prettier eslint-plugin-prettier <span class="token parameter variable">--D</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>commit 注释前缀：</p><ul><li><p>feat 新增功能</p></li><li><p>fix bug 修复</p></li><li><p>style 调整代码（修改缩进、补全分号等）</p></li><li><p>refactor 重构代码</p></li><li><p>docs 更新文档</p></li><li><p>build 构建工具或外部依赖的改动（webpack、npm）</p></li><li><p>chore 小改动</p></li><li><p>revert 版本回退</p></li><li><p>perf 性能优化</p></li><li><p>test 增加测试</p></li></ul>`,26),i=[p];function l(o,c){return s(),a("div",null,i)}const u=n(t,[["render",l],["__file","代码规范.html.vue"]]);export{u as default};
