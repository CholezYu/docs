import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as l,c,b as n,d,e as r,a as s}from"./app-yF-nkpuj.js";const t={},p=s(`<h2 id="部署前端项目" tabindex="-1"><a class="header-anchor" href="#部署前端项目" aria-hidden="true">#</a> 部署前端项目</h2><p>阿里云服务器准备就绪。。。</p><p>在根目录安装 Git。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token function">git</span>
