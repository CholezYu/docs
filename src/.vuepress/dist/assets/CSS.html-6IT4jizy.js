import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as l,c,a as n,b as a,e,d as t}from"./app-k95SP1HN.js";const o={},u=t(`<h2 id="选择器" tabindex="-1"><a class="header-anchor" href="#选择器" aria-hidden="true">#</a> 选择器</h2><h3 id="伪类选择器" tabindex="-1"><a class="header-anchor" href="#伪类选择器" aria-hidden="true">#</a> 伪类选择器</h3><p>link &gt; visited &gt; hover &gt; active</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token comment">/* 未访问过的链接 */</span>
