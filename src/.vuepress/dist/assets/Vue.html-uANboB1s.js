...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="传送组件" tabindex="-1"><a class="header-anchor" href="#传送组件" aria-hidden="true">#</a> 传送组件</h3><p>它可以将组件内部的元素 “传送” 到任意位置。</p><p><code>&lt;Teleport&gt;</code> 接收一个 <code>to</code> prop 来指定传送的目标。值可以是一个 CSS 选择器，也可以是一个 DOM 元素。</p><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token comment">&lt;!-- 将 Dialog 传送至 body 下面 --&gt;</span>
