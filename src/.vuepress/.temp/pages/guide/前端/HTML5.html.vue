<template><div><h1 id="html5" tabindex="-1"><a class="header-anchor" href="#html5" aria-hidden="true">#</a> HTML5</h1>
<h2 id="语义化标签" tabindex="-1"><a class="header-anchor" href="#语义化标签" aria-hidden="true">#</a> 语义化标签</h2>
<h3 id="布局标签" tabindex="-1"><a class="header-anchor" href="#布局标签" aria-hidden="true">#</a> 布局标签</h3>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- 头部 --></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="其他标签" tabindex="-1"><a class="header-anchor" href="#其他标签" aria-hidden="true">#</a> 其他标签</h3>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- 手机电量 --></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="表单控件" tabindex="-1"><a class="header-anchor" href="#表单控件" aria-hidden="true">#</a> 表单控件</h2>
<h3 id="表单标签" tabindex="-1"><a class="header-anchor" href="#表单标签" aria-hidden="true">#</a> 表单标签</h3>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- 调色板 --></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="表单属性" tabindex="-1"><a class="header-anchor" href="#表单属性" aria-hidden="true">#</a> 表单属性</h3>
<ul>
<li>
<p>autocomplete: 显示历史输入（必须设置 name 属性才会生效）</p>
<ul>
<li>
<p>on: 开启（默认）</p>
</li>
...
<li>
<p>autofocus: 自动获取输入框的焦点（无属性值）</p>
</li>
<li>
<p>required: 输入框不能为空（无属性值）</p>
</li>
<li>
<p>readonly: 输入框中的值是只读的，不能被修改（无属性值）</p>
</li>
<li>
<p>multiple: 可以选择多个 option（无属性值）</p>
</li>
<li>
<p><code v-pre>&lt;input type=&quot;file&quot; accept=&quot;image/*&quot;&gt;</code>: 接受的图片格式</p>
</li>
<li>
<p><code v-pre>&lt;input type=&quot;file&quot; capture=&quot;camera&quot;&gt;</code>: 调用相机权限</p>
</li>
<li>
<p><code v-pre>&lt;input type=&quot;file&quot; capture=&quot;photo&quot;&gt;</code>: 调用相册权限</p>
</li>
</ul>
<h2 id="媒体标签" tabindex="-1"><a class="header-anchor" href="#媒体标签" aria-hidden="true">#</a> 媒体标签</h2>
<h3 id="音频标签" tabindex="-1"><a class="header-anchor" href="#音频标签" aria-hidden="true">#</a> 音频标签</h3>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- 音频 --></span>
...
<li>
<p>controls: 允许用户控制播放（无属性值）</p>
</li>
<li>
<p>autoplay: 自动播放（无属性值）</p>
</li>
<li>
<p>muted: 静音（无属性值）</p>
</li>
...
<h3 id="视频标签" tabindex="-1"><a class="header-anchor" href="#视频标签" aria-hidden="true">#</a> 视频标签</h3>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- 视频 --></span>
...
<li>
<p>controls: 允许用户控制播放进度条（无属性值）</p>
</li>
<li>
<p>autoplay: 自动播放（无属性值，必须静音）</p>
</li>
<li>
<p>muted: 静音（无属性值）</p>
</li>
...
<li>
<p>poster: 海报帧的路径，显示视频封面（值为图片地址）</p>
</li>
<li>
<p>preload: 视频预加载模式</p>
<ul>
