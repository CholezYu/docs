<template><div><h1 id="webgl" tabindex="-1"><a class="header-anchor" href="#webgl" aria-hidden="true">#</a> WebGL</h1>
...
<li>
<p><code v-pre>gl.clearColor(r, g, b, a)</code> 清空 canvas 的颜色</p>
</li>
<li>
<p><code v-pre>gl.clear(buffer)</code> 清空缓存</p>
<ul>
<li>
<p>gl.COLOR_BUFFER_BIT: 颜色缓存</p>
</li>
<li>
<p>gl.DEPTH_BUFFER_BIT: 清空深度缓冲区</p>
</li>
<li>
<p>gl.STENCLI_BUFFER_BIT: 清空模板缓冲区</p>
</li>
</ul>
</li>
</ul>
<h2 id="着色器" tabindex="-1"><a class="header-anchor" href="#着色器" aria-hidden="true">#</a> 着色器</h2>
<h3 id="顶点着色器" tabindex="-1"><a class="header-anchor" href="#顶点着色器" aria-hidden="true">#</a> 顶点着色器</h3>
<p>用来描述顶点（空间中的坐标）的特性，通过计算获取<strong>位置</strong>信息</p>
<h3 id="片元着色器" tabindex="-1"><a class="header-anchor" href="#片元着色器" aria-hidden="true">#</a> 片元着色器</h3>
<p>进行逐片元（像素）处理程序，通过计算获取<strong>颜色</strong>信息</p>
<h3 id="着色器源码" tabindex="-1"><a class="header-anchor" href="#着色器源码" aria-hidden="true">#</a> 着色器源码</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 顶点着色器源程序</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="创建着色器" tabindex="-1"><a class="header-anchor" href="#创建着色器" aria-hidden="true">#</a> 创建着色器</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">useShader</span><span class="token punctuation">(</span><span class="token parameter">gl<span class="token punctuation">,</span> <span class="token constant">VERTEX_SHADER_SOURCE</span><span class="token punctuation">,</span> <span class="token constant">FRAGMENT_SHADER_SOURCE</span></span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="绘制图形" tabindex="-1"><a class="header-anchor" href="#绘制图形" aria-hidden="true">#</a> 绘制图形</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token function">useShader</span><span class="token punctuation">(</span>gl<span class="token punctuation">,</span> <span class="token constant">VERTEX_SHADER_SOURCE</span><span class="token punctuation">,</span> <span class="token constant">FRAGMENT_SHADER_SOURCE</span><span class="token punctuation">)</span>
...
<li>
<p><code v-pre>gl.drawArrays(mode, first, count)</code></p>
<ul>
<li>
<p>mode: 绘制的图形</p>
</li>
...
<h3 id="attribute-变量" tabindex="-1"><a class="header-anchor" href="#attribute-变量" aria-hidden="true">#</a> attribute 变量</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// attribute 变量只能用于顶点着色器源程序中</span>
<span class="token keyword">const</span> <span class="token constant">VERTEX_SHADER_SOURCE</span> <span class="token operator">=</span> <span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">
