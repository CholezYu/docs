<template><div><h1 id="bootstrap" tabindex="-1"><a class="header-anchor" href="#bootstrap" aria-hidden="true">#</a> Bootstrap</h1>
<h2 id="栅格系统" tabindex="-1"><a class="header-anchor" href="#栅格系统" aria-hidden="true">#</a> 栅格系统</h2>
<p>https://v5.bootcss.com/docs/layout/containers/</p>
<p>https://v5.bootcss.com/docs/layout/grid/</p>
<table>
<thead>
<tr>
...
<td style="text-align:center">1320px</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>.col-</code></td>
<td style="text-align:center"><code v-pre>.col-sm-</code></td>
<td style="text-align:center"><code v-pre>.col-md-</code></td>
<td style="text-align:center"><code v-pre>.col-lg-</code></td>
<td style="text-align:center"><code v-pre>.col-xl-</code></td>
<td style="text-align:center"><code v-pre>.col-xxl-</code></td>
</tr>
</tbody>
</table>
