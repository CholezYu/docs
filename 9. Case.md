...
已知有一个 url 地址: `http://www.baidu.com?username=laowang&password=123&age=18`

收集这个 url 地址的查询字符串，组成一个对象

```js
let url = "http://www.baidu.com?username=Paul&password=123"
...
已知一个对象 { a: 1, b: 2, c: 3 } 和一个 url `http://www.baidu.com`

要得到 `http://www.baidu.com?a=1&b=2&c=3`
...
url.slice() // "http://www.baidu.com?a=1&b=2&c=3"
```
