...
非严格模式下 this 指向 window，严格模式下指向 undefined
...
const per = new Person("小明", 20) // this => per
```
...
`fun.bind(thisArg, arg)`

fun 中的 this 指向 thisArg

- thisArg: 作为 fun 的 this
...
fun.call({ name: "Evan You", age: 36 }, "Singapore")    // this => thisArg
fun.apply({ name: "Evan You", age: 36 }, ["Singapore"]) // this => thisArg
fun.bind({ name: "Evan You", age: 36 })("Singapore")    // this => thisArg
```
...
Function 是 Function 的实例化对象 => `Function instanceof Function`

```js
// 因为任何函数都是 Function 的实例化对象
...
Object 是 Function 的实例化对象 => `Function instanceof Object`
...
Function.\_\_proto\_\_ 是 Object 的实例化对象 => `Object instanceof Function`

```js
// 因为 Function 的显式原型是 Object 的实例化对象
new Object() => Function.prototype

// 所以
Function.prototype.__proto__ === Object.prototype

// 又因为 Function 的隐式原型是 Function 的显式原型
Function.__proto__ === Function.prototype
...
Object.\_\_proto\_\_ 是 Object 的实例化对象 => `Object instanceof Object`

```js
// 因为任何函数都是 Function 的实例化对象，所以任何函数的隐式原型都相等
Object.__proto__ === Function.__proto__

// 又因为 Function 的隐式原型是 Object 的实例化对象
Function.__proto__.__proto__ === Object.prototype
